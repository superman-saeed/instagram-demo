...
const PhotoAlbum=({tabClicked,getState,setState,userRoute})=>{
  const {isgrid,istags,iscollection} =getState();
  ...
  <div>
    <div className="photo-line bborder">
      ...
      <div><a href="#tags" onClick={(e)=>tabClicked(e)}><FontAwesomeIcon icon="id-card-alt" size="lg" /></a></div>
        ...
        {isgrid ? <PhotoGrid photos={getState} setState={setState} path={userRoute}/> : null}
